...
const Profile = () => {
	...
	return (
		<div className="card">
			...
			<p>
				You are logged in, and a Session has been created. The SDK
				stores the Session as a token and a JWT in the browser cookies
				as <span className="code">stytch_session</span> and{" "}
